    ...
    <div class="p-5 text-center ">
        ...
        <div id="respond-page" class="respond list-content mx-auto mt-5">
            ...
            <div id="tokuda__">
                ...
                <a href="https://ngocnui0412.site" style="color:#F00"><b>Copyright © 2023 By <?=$author?></b><br></a>
        ...
        <div class="corner-icon-container">
            <div class="corner-icon corner-icon-github">
                <a class="" href="//github.com/Nguyenbaongoc07" target="_blank" data-toggle="tooltip" data-placement="left"
                    data-original-title="Github">
                    <img height="23" width="23" src="<?=Directory('img');?>github-color-td.svg" alt="My Github">
                </a>
            </div>
            <div class="corner-icon corner-icon-qrcode">
                <a class="" href="https://ngocnui0412.site/nhac/m%c3%a3%20qr.png" target="_blank"
                    data-toggle="tooltip" data-placement="left" data-original-title="Mã qr của trang này">
